...
//////////////////////////////////////////////////////////////////////////
// ATerrainGenCharacter

ATerrainGenCharacter::ATerrainGenCharacter()
{
...
void ATerrainGenCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ATerrainGenCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATerrainGenCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATerrainGenCharacter::Look);

	}

}

void ATerrainGenCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATerrainGenCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
